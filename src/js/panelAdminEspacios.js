document.addEventListener("DOMContentLoaded", function () {
    ...
    function validarSesionAdmin() {
        ...
        fetch("../php/sessionAdmin.php")
            ...
            .then(data => {
                ...
                if (!idUrbanizacion) {
                    mostrarModalMensaje("Selecciona una urbanizacion antes de gestionar sus espacios.", false, function () {
    ...
    function prepararNuevoEspacio() {
        ...
        createSpaceLink.addEventListener("click", function (event) {
            if (!idUrbanizacion) {
                event.preventDefault();
                mostrarModalMensaje("Selecciona una urbanizacion antes de crear espacios.", false, function () {
                    window.location.href = URBANIZACIONES_URL;
                });
                return;
            }
    ...
    function pintarEspacios(espacios) {
        ...
        if (espacios.length === 0) {
            mostrarMensaje("Todavia no hay espacios registrados para esta urbanizacion.");
            return;
        }
    ...
    function crearFilaEspacio(espacio) {
        ...
        const horario = espacio.hora_apertura && espacio.hora_cierre
    ...
    function eliminarEspacio(idEspacio) {
        ...
        fetch("../php/espacios.php", {
            ...
            .then(data => {
                ...
                mostrarModalMensaje(correcto ? "Espacio eliminado" : (data.message || "Hubo algun fallo"), correcto, function () {
                    if (correcto) {
                        cargarEspacios();
                    }
                });
    ...
    function actualizarContador(total) {
        ...
        spacesCount.textContent = total === 1 ? "Mostrando 1 espacio" : `Mostrando ${total} espacios`;
    }

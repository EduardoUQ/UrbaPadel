...
VALUES ('admin@urbanpadel.com', '$2y$10$pWz3iNJcO1JS5WH8WCmE3OMY.w5EQedq4zclVf0VZy5W4T/pMkcO6', 'Administrador Principal');

INSERT INTO urbanizacion (nombre, direccion, codigo_postal, municipio, provincia)
VALUES ('Urbanizacion Las Palmeras', 'Calle de las Palmeras, 123', '28001', 'Madrid', 'Madrid');

INSERT INTO urbanizacion (nombre, direccion, codigo_postal, municipio, provincia)
VALUES ('Urbanizacion Los Pinos', 'Avenida de los Pinos, 45', '28002', 'Madrid', 'Madrid');

INSERT INTO espacio (id_urbanizacion, nombre, tipo, descripcion)
VALUES (1, 'Pista de Padel 1', 'Padel', 'Pista de padel con cesped artificial y sistema de iluminacion nocturna. Ideal para partidos y entrenamientos.');
...
VALUES (1, 'A-101', 'usuario101', '$2y$10$WMOdvJYIgpkpvGnLbMv9HOkljOCVwg37MqgR5P2tNFmsJCYpEjVZa', 'usuario101@urbanpadel.com', '123456789');

INSERT INTO vivienda (id_urbanizacion, codigo_vivienda, nombre_usuario, passwd_hash, email_notificaciones, telefono_contacto)
VALUES (2, 'B-201', 'usuario201', '$2y$10$MAmXsxpYOKlL1PyBOQpYueeB2wnRQ/Y0pE22y0sAYMsZoqLsByVYy', 'usuario201@urbanpadel.com', '987654321');
